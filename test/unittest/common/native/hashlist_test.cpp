...
HWTEST_F(HashListTest, begin, TestSize.Level0)
{
    HashList<std::size_t, std::size_t> hashList {size_};
    for (std::size_t curSize = 0; curSize < size_; ++curSize) {
        hashList.push_back(curSize, curSize);
...
HWTEST_F(HashListTest, cbegin, TestSize.Level2)
{
    HashList<std::size_t, std::size_t> hashList {size_};
    for (std::size_t curSize = 0; curSize < size_; ++curSize) {
        hashList.push_back(curSize, curSize);
...
HWTEST_F(HashListTest, cend, TestSize.Level2)
{
    HashList<std::size_t, std::size_t> hashList {size_};
    for (std::size_t curSize = 0; curSize < size_; ++curSize) {
        hashList.push_back(curSize, curSize);
...
HWTEST_F(HashListTest, crbegin, TestSize.Level2)
{
    HashList<std::size_t, std::size_t> hashList {size_};
    for (std::size_t curSize = 0; curSize < size_; ++curSize) {
        hashList.push_back(curSize, curSize);
...
HWTEST_F(HashListTest, back, TestSize.Level2)
{
    HashList<std::size_t, std::size_t> hashList {size_};
    for (std::size_t curSize = 0; curSize < size_; ++curSize) {
        hashList.push_back(curSize, curSize);
...
HWTEST_F(HashListTest, push_back, TestSize.Level2)
{
    HashList<std::size_t, std::size_t> hashList {size_};
    constexpr std::size_t size {20};
    for (std::size_t curSize = 0; curSize < size; ++curSize) {
...
HWTEST_F(HashListTest, pop_back, TestSize.Level2)
{
    HashList<std::size_t, std::size_t> hashList {size_};
    for (std::size_t curSize = 0; curSize < size_; ++curSize) {
        hashList.push_front(curSize, curSize);
...
HWTEST_F(HashListTest, clear, TestSize.Level2)
{
    HashList<std::size_t, std::size_t> hashList {size_};
    constexpr std::size_t size = 20;
    for (std::size_t curSize = 0; curSize < size; ++curSize) {
